...
- [2026-07-12 deepseek-v4-flash（诊断轨 v5）](results/2026-07-12-deepseek-v4-flash-diagnostic-v5.md)：
  v0.1.10 正式运行三轮 41/48、43/48、43/48；五项行为任务稳定失败，
  Tool Contract 转 **go（设计评估）**，Semantic Metadata 与 Query
  Expressiveness 维持 no-go，Catalog Discovery 继续观察。
